...
//       try {
//         console.log(`📝 Procesando curso ${index + 1}/${allExternalCourses.length}: ${externalCourse.code}`)

//         // Validar datos requeridos
//         if (!externalCourse.code) {
//           console.warn(`⚠️ Curso sin código en índice ${index}, saltando...`)
//           validationErrors.push(`Curso en índice ${index}: Sin código`)
//           errors++
//           continue
//         }
...
//         errors++
//         errorDetails.push({
//           course: externalCourse.code || `Índice ${index}`,
//           error: error.message,
...
//       },
//       errorDetails: errorDetails.length > 0 ? errorDetails.slice(0, 10) : undefined, // Solo primeros 10 errores
...
//         explanation:
//           allExternalCourses.length !== totalInDB
//             ? "Algunos registros no se guardaron debido a errores de validación o duplicados"
//             : "Totales coinciden correctamente",
//       },
//     }

//     console.log("🎉 Sincronización completada:", response.summary)
